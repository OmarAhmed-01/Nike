...
const WomenClothing = () => {
    ...
    const WomenProducts = products.filter(product => product.category.includes("Women") && product.category.includes("Clothing"));
  return (
    <div className='women-container'>
        <div className="women-products">
            <h1>Women Clothing ({WomenProducts.length})</h1>
