...
const WomenBrasLeggings = () => {
    const { handleProductClick } = useContext(StoreContext)
    const WomenProducts = products.filter(product => product.category.includes("Women") && product.category.includes("Bras"));
  return (
    <div className='women-container'>
        <div className="women-products">
            <h1>Women Bras & Leggings ({WomenProducts.length})</h1>
...
export default WomenBrasLeggings