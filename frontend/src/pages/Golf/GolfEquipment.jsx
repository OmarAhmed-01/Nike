...
const GolfEquipment = () => {
    ...
    const golfProducts = products.filter(product => product.category.includes("Golf") && product.category.includes("Equipment"));

  return (
    <div className=' golf-container'>
        <div className=' golf-products'>
            <h1>Golf Equipments & Accessories ({golfProducts.length})</h1>
