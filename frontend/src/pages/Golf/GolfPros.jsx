...
const GolfPros = () => {
    ...
    const golfProducts = products.filter(product => product.category.includes("Golf") && product.category.includes("Pro"));

  return (
    <div className=' golf-container'>
        <div className=' golf-products'>
            <h1>Dress Like the Pros ({golfProducts.length})</h1>
